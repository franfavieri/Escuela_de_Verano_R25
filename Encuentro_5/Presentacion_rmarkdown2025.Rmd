...
---
El paquete xaringan en R se usa para crear presentaciones en formato HTML con un estilo profesional y flexible. Está basado en remark.js, un marco de presentaciones en JavaScript, y permite generar diapositivas directamente desde un archivo RMarkdown (.Rmd).

bookdown: Para crear libros, informes y documentación
bookdown permite escribir libros, informes y documentos extensos en R Markdown y exportarlos a PDF, HTML o EPUB.

blogdown: Para crear blogs y sitios web con R Markdown
blogdown permite crear blogs y páginas web estáticas 
---
# ¿Cómo generar un R Markdown? Abrir nuevo archivo
...
---
# Rmarkdown - Componentes (YAML, chunk, texto)
